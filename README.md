...
After running tests, you can find the test report at <a href="/backend/reports/" target="_blank">test-report.html</a> in "reports" folder  and the coverage report at "coverage" folder.
